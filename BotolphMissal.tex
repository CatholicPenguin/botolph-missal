...
%Rubrics:
	%Colour for print:
	\definecolor{RubricRed}{cmyk}{0.1, 1, 1, 0.25}
...
\include{pages/Front/Preface}
%Table of the Year:
\include{pages/Front/TableYear}
%Rubrics \& Ranking
\cleardoublepage
\include{pages/Front/Rubrics}
...
\include{pages/Propers/HolyWeek}
\include{pages/Propers/GoodFriday}
%Easter Even
\cleardoublepage
\include{pages/Propers/EasterEvenCover}
\include{pages/Propers/EasterEven}
%Continuation of Propers
\cleardoublepage
\include{pages/Propers/PaschalPropersCover}
\include{pages/Propers/PostEaster}
%Pre-Mass
\cleardoublepage
\include{pages/Eucharistic/EucharisticCover}
\include{pages/Eucharistic/Asperges}
\include{pages/Eucharistic/ForeMass}
%Holy Mass
\cleardoublepage
\include{pages/Mass/MassCover}
\include{pages/Mass/HolyMass}
\include{pages/Mass/PreCommunion}
\include{pages/Mass/Prefaces}
%Proper of Saints
\cleardoublepage
\include{pages/Propers/SanctoraleCover}
\include{pages/Propers/PropTime}
\include{pages/Propers/Seasonal}
%Common of Saints
\cleardoublepage
\include{pages/Commons/CommonsCover}
\include{pages/Commons/Commons}
%Votive Masses
\cleardoublepage
\include{pages/Votives/VotiveCover}
