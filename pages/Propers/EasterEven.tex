...
\clearpage
\begin{rubric}
	The Celebrant sings the \blackrubric{Alleluia} through thrice, raising his voice each time: the Choir repeats it each time in the same tone.
\end{rubric}
...
\begin{tcolorbox}[
	...
	\textsc{Alleluia! Christ is Risen!}\\
	\textsc{Indeed, He is Risen! Alleluia!}
\end{tcolorbox}
\end{center}